...
//               locals. Whether you are exploring the city or going on a weekend
//               trip, our app has the right car for you.
//             </p>
...
// export const metadata: Metadata = {
//   title: "KarKonnect | SignIn Page",
//   description: "Rent a vehicle easily",
// };
      ...
      <div className="flex flex-wrap items-center">
        {/* <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
              KarConnect is a mobile application that serves as a bridge between car owners looking to rent out their vehicles and customers in need of convenient and affordable transportation. The app offers a user-friendly interface for booking and managing rentals, ensuring a seamless experience for both parties.
              </p>
