...
//   title: "SignUp | KarConnect",
//   description: "Sign up for free | KarConnect",
//   // other metadata
// };
        ...
        {/* /* <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            ...
            <p className="2xl:px-20">
              provides a seamless booking experience for both tourists and
              locals. Whether you&apos;re exploring the city or going on a
              weekend trip, our app has the right car for you.
            </p>
